define([
	...
	var htmlResult = [
		...
		'<td class="username">',
		'	<div class="display"><%=name%></div><div class="edit"><input class="form-input" name="name" data-id="<%= _id %>"/></div>',
		'</td>',
		'<td class="username">',
		'	<div class="display"><%=content%></div><div class="edit"><input class="form-input" name="content" data-id="<%= _id %>"/></div>',
		'</td>',

		'<td class="age">',
		'	<div class="display"><%= imageUrl %></div><div class="edit"><input class="form-input imageUrl" name="imageUrl" data-id="<%= _id %>"/></div>',
		'</td>',
